...
val moduleApplications = module{
    ...
    factory<UpdateApplicationCommentsCountUseCase> {
        UpdateApplicationCommentsCountUseCase(get())
    }
    factory<GetFilterApplicationUseCase> {
        GetFilterApplicationUseCase(get())
    }
}